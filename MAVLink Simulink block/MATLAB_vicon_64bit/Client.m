...
%% GetGlobalForceVector
    function [Output] = GetGlobalForceVector( obj, ForcePlateIndex )
      % Local Data
      vResult = 0;
      pResult = libpointer( 'uint32Ptr', vResult );
      ...
      % Call function
      calllib( 'ViconDataStreamSDK_MATLAB', 'GetGlobalForceVector_v2', obj.InstanceID, ForcePlateIndex, pForceVector, pResult );
...
%% GetGlobalMomentVector
    function [Output] = GetGlobalMomentVector( obj, ForcePlateIndex )
      % Local Data
      vResult = 0;
      pResult = libpointer( 'uint32Ptr', vResult );
      ...
      % Call function
      calllib( 'ViconDataStreamSDK_MATLAB', 'GetGlobalMomentVector_v2', obj.InstanceID, ForcePlateIndex, pMomentVector, pResult );
...
%% GetGlobalCentreOfPressure
    function [Output] = GetGlobalCentreOfPressure( obj, ForcePlateIndex )
      % Local Data
      vResult = 0;
      pResult = libpointer( 'uint32Ptr', vResult );
      ...
      % Call function
      calllib( 'ViconDataStreamSDK_MATLAB', 'GetGlobalCentreOfPressure_v2', obj.InstanceID, ForcePlateIndex, pCentreOfPressure, pResult );

...
%for XYZ and Psi 
A = [1 sample_time sample_time*sample_time/2 zeros(1,9);0 1 sample_time zeros(1,9);0 0 1 zeros(1,9);0 0 0 1 sample_time sample_time*sample_time/2 zeros(1,6);zeros(1,4) 1 sample_time zeros(1,6);zeros(1,5) 1 zeros(1,6);zeros(1,6) 1 sample_time sample_time*sample_time/2 zeros(1,3);zeros(1,7) 1 sample_time zeros(1,3);zeros(1,8) 1 zeros(1,3);zeros(1,9) 1 sample_time sample_time*sample_time/2;zeros(1,10) 1 sample_time;zeros(1,11) 1];

%% 
% Process noise covariance:

% diag([0 0.001 0.001 0 0.001 0.001 0 0.001 0.001]);
diag([0 0.001 0.001 0 0.001 0.001 0 0.001 0.001 0 0.001 0.001]);

%% 
% Measurement matrix:   
% [1 zeros(1,8); zeros(1,3) 1 zeros(1,5);zeros(1,6) 1 0 0]
[1 zeros(1,11); zeros(1,3) 1 zeros(1,8);zeros(1,6) 1 zeros(1,5);zeros(1,9) 1 0 0]

%% 
% Measurement noise covariance:

% 0.001*eye(3)
diag([0.001 0.001 0.001 0.05]);
